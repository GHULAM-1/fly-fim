      ...
      <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-28 mb-12 md:mb-0">
        <div className="2xl:max-w-screen-xl mx-auto">
          <div className="py-6 sm:py-10 border-b">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-sm text-gray-500 gap-10 md:gap-20 mt-10">
              <div>
                <ul className="space-y-4">
                  <li className="font-heading">GET HELP 24/7</li>
              ...
              <div className="grid grid-cols-2 gap-4 w-full lg:col-span-2">
                <ul className="space-y-4">
                  <li className="font-heading">CITIES</li>
                  ...
                  <li className="cursor-pointer hover:text-primary">Roma</li>
                  <li className="cursor-pointer hover:text-primary">París</li>
                  <li className="cursor-pointer hover:text-primary">Londres</li>
                  <li className="cursor-pointer hover:text-primary">Dubái</li>
                  <li className="cursor-pointer hover:text-primary">
                    Barcelona
                  </li>
                  <li className="cursor-pointer hover:text-primary">
                ...
                <ul className="space-y-4">
                  <li className="font-heading">FLYFIM</li>
                  <li className="cursor-pointer hover:text-primary">
                    Our story
                  </li>
              ...
              <div>
                <ul className="space-y-4">
                  <li className="font-heading">PARTNERS</li>
                  <li className="cursor-pointer hover:text-primary">
                ...
                <div className="mt-10">
                  <p className="font-heading">WE ACCEPT</p>
          ...
          <div className="py-5 flex flex-col sm:flex-row justify-between gap-4">
            <ul className="text-xs text-gray-500 flex items-center gap-4">
              ...
              <li className="cursor-pointer hover:text-primary">•</li>
              <li className="cursor-pointer hover:text-primary">
                Privacy policy
              </li>
              <li className="cursor-pointer hover:text-primary">•</li>
