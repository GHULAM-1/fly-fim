...
import { createCity } from "@/api/cities/cities-api";
...
const NewCity = ({ onBack, onSuccess }: NewCityProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        console.error('Error creating city:', apiError);
        setSubmitError(apiError.message || 'Failed to create city. Please try again.');
      } finally {
        ...
        <div className="max-w-[1200px] mx-auto px-[24px] xl:px-0 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-800">New City</h1>
            </div>
            <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-green-800">
                      City created successfully! Redirecting...
                    </p>
                  </div>
                </div>
              </div>
