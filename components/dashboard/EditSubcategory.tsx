...
import { fetchSubcategoryById, updateSubcategory, Subcategory } from "@/api/subcategory/subcategory-api";
...
const EditSubcategory = ({ subcategoryId, onBack, onSuccess }: EditSubcategoryProps) => {
  ...
  useEffect(() => {
    const loadSubcategoryData = async () => {
      try {
        ...
        setLoadError('Failed to load subcategory data: ' + error.message);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        const response = await updateSubcategory(subcategoryId, subcategoryData);
        ...
        console.error('Error updating subcategory:', apiError);
        setSubmitError(apiError.message || 'Failed to update subcategory. Please try again.');
      } finally {
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-green-800">
                      Subcategory updated successfully! Redirecting...
                    </p>
                  </div>
                </div>
              </div>
