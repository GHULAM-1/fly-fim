...
const Activities = () => {
  ...
  const activities = [
    ...
    },
    {
      ...
      itemId: "disneyland-paris-tickets",
    },
    {
      id: 5,
      ...
      itemId: "sydney-opera-house-tour",
    },
    {
      id: 6,
      ...
      <div className="max-w-[1200px] mx-auto 2xl:px-0">
        ...
        >
          {activities.map((activity) => (
            <Link
              href={`/things-to-do/${activity.city}/${activity.category}/${activity.subcategory}/${activity.itemId}`}
              key={activity.id}
