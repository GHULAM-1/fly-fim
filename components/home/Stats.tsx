    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-28 py-10 2xl:max-w-screen-xl mx-auto 2xl:px-0">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-10 mt-4 md:mt-10">
        <div>
          ...
          <p className="mt-2 text-xs md:text-sm">{t("stats.reviews")}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm">{t("stats.media.description")}</p>
        </div>
        <div>
          ...
          <p className="text-xs sm:text-sm">{t("stats.support.description")}</p>
        </div>
      </div>
    </div>
  );
