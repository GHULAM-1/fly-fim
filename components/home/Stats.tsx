  ...
  >
    ...
    <defs>
      <clipPath id="happy-customers-dweb">
        <path fill="#fff" transform="translate(0 6)" d="M0 0h74v74H0z"></path>
      </clipPath>
    </defs>
  </svg>
);
...
const MediaIcon = () => (
  ...
  >
    ...
    <g clipPath="url(#feature-media-dweb)" fill="#0A9E01">
      <path d="M27.074 34.963v9h-9v18h-9v-18h-9v-9h27zM54.074 34.963h-18v9h18v-9z"></path>
...
const TrustpilotStars = () => (
  <div className="h-[115px] md:mt-2 md:w-[15.625rem] -ml-1">
    <img
...
const Stats = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto my-[20px] md:my-[56px] lg:my-[56px] py-[32px] lg:py-[40px] xl:px-0">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-heading text-gray-700">
          {t(
            "stats.title",
            "We've served 42 million+ guests and we are here for you"
          )}
        </h2>
        <div className="mt-8 md:mt-[64px] grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-6   text-[15px]">
          <div className="flex flex-col">
            <TrustpilotStars />
            <p className="mt-2 text-sm text-gray-500  font-halyard-text  text-[15px]">
              {t(
                "stats.reviews",
          ...
          <div className="flex flex-col">
            <HappyCustomersIcon />
            <p className="mt-4 font-heading text-xl text-gray-700">
              {t("stats.customers.count", "42 million+")}
            </p>
            <span className="mt-1 text-sm text-gray-500 font-halyard-text   text-[15px]">
              {t(
          ...
          <div className="flex flex-col">
            <MediaIcon />
            <p className="mt-4 font-heading text-xl text-gray-700">
              {t("stats.media.title", "In the media")}
            </p>
            <span className="mt-2 ml-[4px] font-halyard-text text-gray-500 text-[15px]">
              {t(
                "stats.media.description",
          ...
          <div className="flex flex-col">
            <SupportIcon />
            <p className="mt-4 font-heading text-xl text-gray-700">
              {t("stats.support.title", "24 x 7 help center")}
            </p>
            <span className="mt-1 text-sm text-gray-500 font-halyard-text   text-[15px]">
              {t(
